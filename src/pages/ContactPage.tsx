...
const ContactPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Thank you for your message! This is a demo form (no backend submission).');
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">contact@satuatap.com</p>
                    <p className="mt-1 text-gray-600">info@satuatap.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">Jakarta, Indonesia</p>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="bg-gray-100 p-3 rounded-full hover:bg-teal-100 transition-colors"
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-sm text-gray-500 text-center">
                  * This is a demo form. No actual submission is made.
                </p>
              </form>
            </div>
          </div>
